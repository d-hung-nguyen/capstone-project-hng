...
export default function CreateCatForm() {
 ...
 const CustomToastContent = () => (
  <div>
   ...
   <ButtonContainer>
    <BlackButtonT onClick={() => router.push("/lists/cats")}>View Cats List</BlackButtonT>
    <BlackButtonT onClick={() => toast.dismiss()}>Add another cat</BlackButtonT>
    ...
    <Card>
     ...
     <F1 onSubmit={handleSubmit}>
      ...
      <FormField>
       ...
       <Select name="gender" value={catData.gender} onChange={handleChange}>
      ...
      <FormField>
       ...
       <Input type="date" name="dateOfBirth" value={catData.dateOfBirth} onChange={handleChange} />
      </FormField>
      <FormField>
      ...
      <FormField1>
       ...
       <input type="checkbox" name="active" checked={catData.active} onChange={handleChange} />
      </FormField1>
     </F1>
     <ButtonContainer>
